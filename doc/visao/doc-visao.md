...
|  RF00  | Sistema de Autenticação de usuario e gerenciamento de usuários |                 Permitir que o usuario se autentique no sistema, cadastre uma nova conta, edite seus dados e faça logout.                  |    Alta    |
...
|  RF00  |                    Gerenciamento de gastos                     |                                      Permitir o registro, edição, exclusão e vizualização de gastos.                                       |    Alta    |
...
|  RF00  |                    Gerenciamento de Contas.                    |     Permitir o cadastro, edição, exclusão e vizualização de contas bancárias vinculadas ao sistema, afim de vincular entradas e saidas     |   Média    |
...
|  RF21  |                   Remover membro da família                    |                                          Terá a opção de remover um membro registrado na família.                                          |   Baixa    |
|  RF22  |          Promover membro para administador da família          |                                Terá a opção de promover um membro da família para administrador da família.                                |   Baixa    |
|  RF00  |                   Sistema de Grupo Familiar                    |      Permitir que o usuário crie, edite e exclua grupos familiares, além de visualizar os gastos individuais e totais de cada membro.      |   Baixa    |
|  RF23  |                        Sistema de Metas                        | O sistema terá um sistema de metas baseada nas receitas e despesas, será definido a partir do perfil do usuario ou de forma personalizada. |   Baixa    |
|  RF24  |                        Cadastrar posts                         |                                                     O usuário poderá registrar posts.                                                      |   Baixa    |
|  RF25  |                        Vizualizar posts                        |                                      O usuário poderá vizualizar os posts criados na página de posts.                                      |   Baixa    |
|  RF26  |                         Excluir posts                          |                                         O usuário poderá excluir os posts registrados no sistema.                                          |   Baixa    |
|  RF27  |                          Editar posts                          |                                          O usuário poderá editar os posts registrados no sistema.                                          |   Baixa    |
|  RF00  |                     Gerenciamento de Posts                     |                             Permitir o administrador crie, edite, exclua posts relacionado a área de finanças.                             |   Baixa    |
|  RF28  |                       Cadastrar marcador                       |                                         O usuário poderá cadastrar um novo marcador na sua conta.                                          |   Baixa    |
|  RF29  |                       Vincular marcador                        |                               O usuário poderá vincular uma transação a um marcador registrado em sua conta.                               |   Baixa    |
|  RF30  |                      Vizualizar marcador                       |                                    O usuário poderá vizualizar os marcadores registrados em sua conta.                                     |   Baixa    |
|  RF31  |                        Excluir marcador                        |                                       O usuário poderá excluir um marcador registrado em sua conta.                                        |   Baixa    |
|  RF32  |                        Editar marcador                         |                                  O usuário poderá editar os dados de um marcador registrado em sua conta.                                  |   Baixa    |
|  RF33  |                       Vizualizar Cotação                       |                                               Permitir vizualizar a cotação de várias moedas                                               |   Baixa    |
|  RF34  |                        Login com Google                        |                                     O usuário poderá logar no sistema através da sua conta do Google.                                      |   Baixa    |
